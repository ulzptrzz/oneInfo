        ...
        <div class="w-full mx-8 my-7 bg-white rounded-2xl shadow-md overflow-hidden">
            ...
            <div class="p-8">
                <form wire:submit="update" enctype="multipart/form-data" class="space-y-6">
                    ...
                    {{-- Link Pendaftaran --}}
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Link Pendaftaran
                            (Opsional)</label>
                        ...
                        @if ($panduan_lomba && !$panduan_file)
                            <p class="text-sm mb-2">
                                ...
                                @if (Str::contains($panduan_lomba, ['http', 'https']))
                                    <a href="{{ $panduan_lomba }}" target="_blank"
                                        class="text-blue-600 underline">Lihat Link</a>
                                @else
                                    <a href="{{ asset('storage/' . $panduan_lomba) }}" target="_blank"
