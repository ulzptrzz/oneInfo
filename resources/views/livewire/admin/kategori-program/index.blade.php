    ...
    <div class="flex-1 ml-64 mr-20 min-h-screen">
        <div class="w-full mx-8 my-7 bg-white rounded-2xl shadow-md overflow-hidden">
            ...
            <div class="bg-[#0C356A] text-white p-7 flex justify-between items-center">
                <h2 class="text-2xl font-bold flex items-center">Daftar Kategori Program</h2>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @foreach ($kategoriProgram as $index => $item)
                                <tr>
                                    ...
                                    <td class="px-6 py-4">
                                        <span
                                            class="text-sm font-medium text-gray-900">{{ $item->nama_kategori }}</span>
                                    </td>
                                    <td class="px-6 py-4">
                    ...
                    @if ($showDeleteModal)
                        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                            <div class="bg-white rounded-lg shadow-xl p-6 max-w-sm w-full">
                                ...
                                <h3 class="text-lg text-center font-semibold mb-1 text-[#0C356A]">Hapus Kategori
                                    Program?</h3>
