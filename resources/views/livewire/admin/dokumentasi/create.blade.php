        ...
        <div class="p-8">
            <form wire:submit.prevent="save" class="space-y-6">
                ...
                <div>
                    ...
                    {{-- Drop Zone --}}
                    <div 
                        class="drop-zone relative rounded-xl p-8 text-center cursor-pointer"
                        id="dropZone"
                        ...
                        {{-- Loading State --}}
                        <div wire:loading wire:target="foto" class="absolute inset-0 bg-white bg-opacity-90 rounded-xl flex items-center justify-center">
                            <div class="text-center">
                                <div class="animate-spin rounded-full h-12 w-12 border-b-2 border-[#FFC436] mx-auto mb-3"></div>
