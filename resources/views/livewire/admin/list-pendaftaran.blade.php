                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-center">
                                    ...
                                    <span class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm">Disetujui</span>

                                    @elseif($p->status === 'finished')
                                    <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm">Selesai</span>

                                    @else
                                    <span class="bg-red-100 text-red-800 px-3 py-1 rounded-full text-sm">Ditolak</span>
                                    @endif
