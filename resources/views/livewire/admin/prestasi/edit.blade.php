            ...
            <form wire:submit.prevent="update" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        placeholder="Contoh: Juara 1 Lomba Cerdas Cermat Tingkat Kota"
                        rows="4"
                        class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 resize-none
                               focus:border-[#FFC436] focus:outline-none transition"
                    ></textarea>
                    @error('deskripsi')
                        <p class="text-red-600 text-sm mt-1 flex items-center gap-1">
