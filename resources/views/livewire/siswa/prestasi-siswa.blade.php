            ...
            @if ($prestasis->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($prestasis as $prestasi)
                        <div
                            class="bg-white rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden">
                ...
                <div class="bg-white rounded-2xl shadow-md p-12">
                    <div class="text-center">
                        ...
                        <p class="text-gray-600 mb-6 max-w-md mx-auto">
                            Kamu belum memiliki prestasi yang tercatat. Ikuti berbagai program dan kompetisi untuk
